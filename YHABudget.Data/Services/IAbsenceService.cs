...
public interface IAbsenceService
{
    ...
    /// <summary>
    /// Calculates absence impact based on salary settings
    /// </summary>
    ...
    /// <returns>Tuple with (deduction, compensation)</returns>
    (decimal Deduction, decimal Compensation) CalculateAbsenceImpact(
        DateTime date, 
        AbsenceType type, 
